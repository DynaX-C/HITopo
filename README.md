...
- **Temporal-split setting**: available [here](链接1)
- **Standard PDBbind2020 setting**: available [here](链接2)
- **CleanSplit protocol**: available [here](链接3)

The original PDBbind data are publicly available from [here](PDBbind原始链接).  
